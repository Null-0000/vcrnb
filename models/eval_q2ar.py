...
parser.add_argument(
    '-answer_preds',
    dest='answer_preds',
    default='saves/flagship_visualBN1_BN1_attenton1(WqWv_not_share_bettewn_qavlstm)_attention2(WqWk_v)_BN1_relu_kaiming_uniform_init_innerproduct/valpreds.npy',
...
parser.add_argument(
    ...
    default='saves/flagship_Rationale_attenton1(WqWv_not_share_bettewn_qavlstm1024)_attention2(WqWk_v)_relu_kaiming_uniform_init_innerproduct/valpreds.npy',
